...
public class Solution {
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            PrintStream defPrintStream = System.out;
            PrintStream printStream = new PrintStream(outputStream);
            System.setOut(printStream);
            string1.print();
            string2.print();
            printStream.close();
            System.setOut(defPrintStream);
        }

        public void load(InputStream inputStream) throws Exception {
            //implement this method - реализуйте этот метод
            int countStrings0 = countStrings;
            BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream));
            int i1 = Integer.valueOf(reader.readLine().replace("string #", ""));
            int i2 = Integer.valueOf(reader.readLine().replace("string #", ""));
            reader.close();
